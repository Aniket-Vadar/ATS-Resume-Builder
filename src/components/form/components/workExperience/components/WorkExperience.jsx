  ...
  return (
    <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-lg space-y-2.5 mb-3 relative group">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        <div>
          <label className="block text-[10px] font-semibold text-slate-500 mb-0.5 tracking-wider uppercase">Company Name</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-[10px] font-semibold text-slate-500 mb-0.5 tracking-wider uppercase">Role / Job Title</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-[10px] font-semibold text-slate-500 mb-0.5 tracking-wider uppercase">Location</label>
          <input
            type="text"
